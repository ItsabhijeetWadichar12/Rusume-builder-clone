    ...
    <div>
      ...
      <form action="actions/updateresume.action.php" method="post" class="row g-3 p-3">
        ...
        <div class="col-md-6">
          ...
          <input type="number" min="1111111111" value="<?= @$resume['mobile_no'] ?>" name="mobile_no" placeholder="9569569569" max="9999999999" class="form-control" required>
        </div>
        <div class="col-md-6">
      ...
      <div class="modal-body">
        <form method="post" action="actions/addexperience.action.php" class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="date" name="started" placeholder="October 2021" class="form-control" id="inputPassword4" required>
          </div>
          <div class="col-md-6">
            <label for="inputPassword4" class="form-label">Resigned</label>
            <input type="date" name="ended" id="#datepicker" class="form-control" placeholder="Currently Pursuing" id="inputPassword4" required>
          </div>
