...
foreach($resumes as $resume){
  ...
  <div class="col-12 col-md-6 p-2">
                    <div class="p-2 border rounded">
                        ...
                        <img src="./assets/images/logo.png" alt="" srcset="" width="500px" height="150px">
                    ...
                    <br>
                    <h4>
                        This Is Sample for Civil  
                    </h4>
                    

                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/01.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
                    ...
                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/02.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
                            <a href="resume02.php?resume=<?=$resume['slug']?>" target="_blank" class="text-decoration-none small"><i class="bi bi-file-text"></i> Open</a>
                            <a href="updateresume.php?resume=<?=$resume['slug']?>" class="text-decoration-none small"><i class="bi bi-pencil-square"></i> Edit</a>
                            <a href="actions/deleteresume.action.php?id=<?=$resume['id']?>" class="text-decoration-none small"><i class="bi bi-trash2"></i> Delete</a>
                    ...
                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/03.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
                            <a href="resume03.php?resume=<?=$resume['slug']?>" target="_blank" class="text-decoration-none small"><i class="bi bi-file-text"></i> Open</a>
                            <a href="updateresume.php?resume=<?=$resume['slug']?>" class="text-decoration-none small"><i class="bi bi-pencil-square"></i> Edit</a>
                            <a href="actions/deleteresume.action.php?id=<?=$resume['id']?>" class="text-decoration-none small"><i class="bi bi-trash2"></i> Delete</a>
                    ...
                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/04.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
                    ...
                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/05.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
                    ...
                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/06.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
                    ...
                    <div class="p-2 border rounded">
                        <!-- <h5><?=$resume['resume_title']?></h5> -->
                        <img src="./assets/images/templates/07.png" alt="" srcset="" width="500px" height="150px">
                        <p class="small text-secondary m-0" style="font-size:12px"><i class="bi bi-clock-history"></i>
                            Last Updated <?=date('d F, Y h:i A',$resume['updated_at'])?>
                        </p>
                        <div class="d-flex gap-2 mt-1">
